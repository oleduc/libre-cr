...
describe("GitHub diff-hash selection", () => {
  it("decodes single lines and shift-click ranges via the path digest", async () => {
    document.body.innerHTML =
      '<table aria-label="Diff for: crates/globset/Cargo.toml"><tbody>' +
      '<tr><td class="blob-num" data-line-number="34">34</td><td class="diff-text-cell" data-diff-side="right" data-line-number="34">replicas,</td></tr>' +
      '<tr><td class="blob-num" data-line-number="35">35</td><td class="diff-text-cell" data-diff-side="right" data-line-number="35">ttl: TTL</td></tr>' +
      "</tbody></table>";
